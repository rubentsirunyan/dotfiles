# Generated by Powerlevel10k configuration wizard on 2020-04-25 at 12:14 +04.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local     staged='%81F'   # blue foreground
      ...
      local     staged='%244F'   # blue foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      res+="${gs}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}"
    ...
    if [[ -n ${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH} ]]; then
      res+="${meta}:${gs}${(V)VCS_STATUS_REMOTE_BRANCH//\%/%%}"  # escape %
    fi
